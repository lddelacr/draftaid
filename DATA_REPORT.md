...
|---|---|---|
| `boone` | 184 | From Justin Boone's top-300, which lists a club for every player |
| `guide` | 65 | Stated in the PDF (player cards, dynasty list, stat notes) |
| `prior` | 2 | Carried from 2025 — **not verified for 2026** |
